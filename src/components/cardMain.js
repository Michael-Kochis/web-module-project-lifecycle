            ...
            <div id="cardMain" className="card-main">
                <div id="cardInfo" className="card-info title-bar" >
                    ...
                    <div id="cardText" className="card-text">
                        ...
                        {this.state && this.state.cardData && this.state.cardData.name?<p id="name" className="name">{this.state.cardData.name}</p>: ""} 
                        {this.state && this.state.cardData && this.state.cardData.location?<p id="location" className="location">Location: {this.state.cardData.location}</p>: "Cards Go Here"} 
                        ...
                        {this.state && this.state.followers && this.state.followers.map(item => {return <p className="follower" key={item.id}>{item.login}</p>})}
